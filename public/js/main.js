...
// lire la suite boutton

$("#suiteBoutton").click(function(){
	$("#suite").toggle("slow")
		if($("#suite").css("display", "block")){
			$("#suiteBoutton").html("<strong>Cacher l'article</strong>")
		}
		else{
			$("#suiteBoutton").html("<strong>Lire la suite</strong>")
		}
})
...
$("#quiSommesNous").click(function(){
	$('#modal-quiSommesNous').modal('show')
})
